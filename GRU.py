...
model.add(
    layers.GRU(512,return_sequences=True,activation='tanh',name='First_Layer')
)

model.add(layers.GRU(512,activation='tanh',name='Second_Layer'))   # Replace GRU by LSTM or SimpleRNN  ==== SimpleRNN < GRU < LSTM
